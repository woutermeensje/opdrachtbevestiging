...
<body style="margin:0;padding:0;background:#ffffff;font-family:Arial,Helvetica,sans-serif;color:#333333;">
    <div style="width:100%;background:#ffffff;padding:32px 16px;box-sizing:border-box;">
        <div style="max-width:720px;margin:0 auto;">
            ...
            <div style="width:100%;background:#FBFAF8;border:1px solid #333;border-radius:5px;overflow:hidden;box-sizing:border-box;margin:0 0 28px;">
                <div style="padding:20px 22px;border-bottom:1px solid #333;">
