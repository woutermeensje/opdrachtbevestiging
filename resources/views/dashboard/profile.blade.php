...
@section('content')
    ...
    <div class="dashboard-content-grid">
        ...
        <section class="dashboard-panel dashboard-panel-wide">
            <h2>Bedrijfsgegevens en documentinstellingen</h2>

            <form method="POST" action="{{ route('dashboard.profile.update') }}" class="dashboard-form" enctype="multipart/form-data" data-kvk-form>
                @csrf
