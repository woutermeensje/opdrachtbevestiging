...
class ConfirmationFlowTest extends TestCase
{
    ...
    public function test_create_confirmation_form_uses_document_builder_fields(): void
    {
        ...
        $response
            ...
            ->assertDontSee('Afspraken')
            ->assertDontSee('Vaste afspraken')
            ->assertDontSee('Velden aanvullen')
            ->assertDontSee('Automatisch toegevoegd')
            ->assertDontSee('Kenmerk opdrachtgever')
            ->assertDontSee('Projectnaam')
            ->assertDontSee('Locatie werkzaamheden')
            ->assertDontSee('Duur van de opdracht')
